...
public extension Color {
    ...
    static let mustardColor = Color(red: 0.996, green: 0.784, blue: 0.408)
    ...
    static let placeholderColor = Color(red: 0.78, green: 0.779, blue: 0.779)
    
    static let lightGrayColor = Color(red: 0.649, green: 0.708, blue: 0.712)
}
